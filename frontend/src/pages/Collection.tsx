  ...
  useEffect(() => {
    const fetchNFTs = async () => {
      try {
        ...
        const response = await fetch('https://polygon-mumbai.g.alchemy.com/nft/v3/DquPqd0BkVZtmd5HQkefL0hbs_SLMLfX/getNFTsForCollection?contractAddress=0x8B276b903Bf2bBF380238388b80353D5A1862D74&withMetadata=true', {
          method: 'GET',
